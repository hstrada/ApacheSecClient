...
public class ClienteSeguro {
	private static EndpointReference targetEPR = new EndpointReference("http://localhost:8080/ApacheSec/services/Ola");
	...
	public static void main(String[] args) {
		try {
			...
			ConfigurationContext configContext = ConfigurationContextFactory
					.createConfigurationContextFromFileSystem("axis-repo", null);
